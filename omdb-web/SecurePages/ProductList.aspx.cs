    ...
    public partial class ProductList : System.Web.UI.Page
    {
        ...
        protected void PaginationTextBox_TextChanged(object sender, EventArgs e)
        {
            ...
            if (page != null && page != "")
            {
                ...
                {
                    Response.Redirect("~/SecurePages/ProductList.aspx?type=" + APIContentType + "&page=" + page, false);
                    Context.ApplicationInstance.CompleteRequest();
                }
                else
                {
                    Response.Redirect("~/SecurePages/ProductList.aspx?type=" + APIContentType + "&page=" + page + "&search=" + APIContentTitle, false);
                    Context.ApplicationInstance.CompleteRequest();
                }
            }
        }
